...
export function meta({}: Route.MetaArgs) {
  return [
    ...
    { name: 'description', content: 'Monitorea y analiza la actividad de los usuarios en el sistema' },
  ];
}
    ...
    <div className="container mx-auto p-3 md:p-8 space-y-8">
      ...
      <Tabs defaultValue="overview" className="space-y-8">
        <TabsList className="flex w-full gap-2 bg-transparent p-0 border-b border-border dark:border-slate-800">
          <TabsTrigger value="overview" className="flex-1 flex flex-col items-center gap-1 px-0 py-2 border-b-2 border-transparent data-[state=active]:border-sky-500 data-[state=active]:text-sky-700 dark:data-[state=active]:text-sky-200 transition-all">
            <BarChart3 className="h-4 w-4 opacity-70" />
            <span className="text-xs font-medium">Resumen</span>
          </TabsTrigger>
          <TabsTrigger value="recent" className="flex-1 flex flex-col items-center gap-1 px-0 py-2 border-b-2 border-transparent data-[state=active]:border-sky-500 data-[state=active]:text-sky-700 dark:data-[state=active]:text-sky-200 transition-all">
            <Clock className="h-4 w-4 opacity-70" />
            <span className="text-xs font-medium">Actividad Reciente</span>
          </TabsTrigger>
          <TabsTrigger value="users" className="flex-1 flex flex-col items-center gap-1 px-0 py-2 border-b-2 border-transparent data-[state=active]:border-sky-500 data-[state=active]:text-sky-700 dark:data-[state=active]:text-sky-200 transition-all">
              ...
              <CardContent className="space-y-4 pt-0">
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 rounded-lg bg-blue-50 dark:bg-blue-950/20">
                    <div>
                      <div className="font-medium text-sm">Almacenamiento Local</div>
