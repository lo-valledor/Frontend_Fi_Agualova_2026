...
import { Download, FileSpreadsheet, Loader2, Filter, X } from "lucide-react";
...
export default function ExportarLecturas() {
  const { periodos, sectores, isLoading, error, activePeriodoId } =
    useMonitor();
  ...
  const headerTitle = "Exportar Lecturas";
  useEffect(() => {
