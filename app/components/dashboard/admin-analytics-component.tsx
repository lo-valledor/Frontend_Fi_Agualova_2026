...
function procesarContratosPorTipo(
  data: Array<{ tipoContrato?: string }>
): { [key: string]: number } {
  return data.reduce(
    (acc, curr) => {
...
function procesarMedidores(data: Array<{
  tipoMedidor?: string;
  estado?: string;
}>): {
...
export const AdminAnalyticsComponent = React.memo(function AdminAnalyticsComponent() {
