  ...
  const renderForm = () => {
    ...
    if (result.Estado === 4) {
      trackDataAction(
        'Abrir formulario',
        'Editar Medidores',
        `Reapertura - Medidor: ${result.ME_NSerie} (${result.tarifa})`
      );
    ...
    if (result.tarifa === 'BT-1' || result.tarifa === 'BT-2') {
      trackDataAction(
        'Abrir formulario',
        'Editar Medidores',
        `BT-1/BT-2 - Medidor: ${result.ME_NSerie} (${result.tarifa})`
      );
    ...
    if (result.tarifa === 'BT-4.3') {
      trackDataAction(
        'Abrir formulario',
        'Editar Medidores',
        `BT-4.3 - Medidor: ${result.ME_NSerie} (${result.tarifa})`
      );
    ...
    trackDataAction(
      'Error formulario',
      'Editar Medidores',
      `Tarifa no soportada: ${result.tarifa}`
    );
    return (
