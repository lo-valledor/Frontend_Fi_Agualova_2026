      ...
      <div className="container mx-auto p-2 space-y-3">
        ...
        <div className="flex items-center gap-3 justify-between">
          <div className="flex items-center gap-3">
            <h1 className="text-3xl font-bold bg-gradient-to-r from-sky-600 to-indigo-600 dark:from-sky-100 dark:to-indigo-100 bg-clip-text text-transparent">
              Crear Archivos para SAP
            </h1>
          </div>
          <div className="flex items-center gap-3">
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Gestión de creación de archivos para SAP
                  </DialogDescription>
                </DialogHeader>
              </DialogContent>
            </Dialog>
