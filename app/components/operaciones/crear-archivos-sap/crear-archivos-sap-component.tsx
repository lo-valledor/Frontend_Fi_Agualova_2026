            ...
            >
              ...
              <CollapsibleContent>
                <CardContent className='p-4 space-y-6'>
                  ...
                  <div className='flex items-center justify-between p-4 rounded-lg border border-sky-200/40 bg-sky-50/30 dark:border-sky-800/40 dark:bg-sky-900/20'>
                    ...
                    <Button
                      ...
                      className='gap-1.5 bg-sky-600 hover:bg-sky-700 text-white shadow-sm'
                    >
