...
export function LoginForm({ className, ...props }: React.ComponentPropsWithoutRef<"div">) {
  ...
  const handleSubmitEvent = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (input.usuario && input.contrasena) {
      try {
        ...
        setErrorMessage(message.includes("Failed to fetch") ? "Error de conexión. Inténtalo de nuevo." : message)
      }
    } else {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-gradient-to-tr from-sky-500 to-teal-400 dark:from-sky-700 dark:to-teal-600 rounded-full opacity-20 blur-2xl animate-pulse" style={{ animationDuration: "8s" }}></div>
      ...
      <div className="p-8 pt-2">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <a
                  href="#"
                  className="text-xs font-medium text-sky-600 dark:text-sky-400 hover:text-sky-500 dark:hover:text-sky-300 transition-colors duration-200"
                >
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            ...
            <a
              href="#"
              className="font-medium text-sky-600 dark:text-sky-400 hover:text-sky-500 dark:hover:text-sky-300 transition-colors duration-200"
            >
              Contacta a soporte
            </a>
          </p>
