...
Defined in: [app/types/monitor.ts:4](https://github.com/lo-valledor/front-respaldo/blob/develop/app/types/monitor.ts#L4)
...
Defined in: [app/types/monitor.ts:10](https://github.com/lo-valledor/front-respaldo/blob/develop/app/types/monitor.ts#L10)
