...
# Interface: CalculoPrefacturaDetalle

Defined in: [app/types/operaciones.ts:200](https://github.com/lo-valledor/front-respaldo/blob/develop/app/types/operaciones.ts#L200)

## Extended by

- [`CalculoPrefacturaCompleto`](CalculoPrefacturaCompleto.md)
