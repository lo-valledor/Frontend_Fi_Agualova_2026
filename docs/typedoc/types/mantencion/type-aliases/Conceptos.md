...
Defined in: [app/types/mantencion.ts:24](https://github.com/lo-valledor/front-respaldo/blob/develop/app/types/mantencion.ts#L24)
...
> `optional` **asociadoId**: `number`

Defined in: [app/types/mantencion.ts:30](https://github.com/lo-valledor/front-respaldo/blob/develop/app/types/mantencion.ts#L30)
