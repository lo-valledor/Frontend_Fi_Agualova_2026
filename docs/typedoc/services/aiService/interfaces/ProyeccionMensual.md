...
Defined in: [app/services/aiService.ts:15](https://github.com/lo-valledor/front-respaldo/blob/develop/app/services/aiService.ts#L15)
...
> `optional` **facturacionProyectada**: `number`
...
> `optional` **facturacionInferior**: `number`
...
> `optional` **facturacionSuperior**: `number`
...
Defined in: [app/services/aiService.ts:27](https://github.com/lo-valledor/front-respaldo/blob/develop/app/services/aiService.ts#L27)
